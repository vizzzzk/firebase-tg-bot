      ...
      try {
        ...
        if (error.code === 'auth/email-already-in-use') {
          ...
          message = "The password is too weak.";
            ...
            message = "PROJECT SETUP ISSUE: Email/password sign-up is not enabled in the Firebase project. Please enable it in the Firebase console authentication settings.";
        } else if (error.code === 'auth/api-key-not-valid') {
            message = "PROJECT SETUP ISSUE: The Firebase API Key is invalid. Please ensure it is correct in your project configuration.";
        }
    ...
    startAuthTransition(async () => {
      ...
      } catch (error: any)
      {
         ...
         if (error.code === 'auth/user-not-found' || error.code === 'auth/wrong-password' || error.code === 'auth/invalid-credential') {
            ...
            message = "PROJECT SETUP ISSUE: Email/password sign-in is not enabled in the Firebase project. Please enable it in the Firebase console authentication settings.";
        }
